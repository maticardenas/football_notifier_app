...
class TeamFixturesManager:
    ...
    #         ):
    #             self._perform_line_up_confirmed_notification(
    #             next_team_fixture)
    #         else:
    #             print(
    #                 f"There is still no line up for the match of {
    #                 next_team_fixture.home_team} vs {
    #                 next_team_fixture.away_team}"
    #             )
    ...
    #     # telegram
    #     team_standing_msg = (
    #         f"{Emojis.RED_EXCLAMATION_MARK.value} Situación actual en el
